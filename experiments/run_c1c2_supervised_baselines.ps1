...
# 132 runs = 2 arms x 11 tasks x 6 seeds. Estimated 1.5 h total; pilot 12.5 min.
...
$full = @(
  ...
  @('conv_supervised', 'eb', 3),
  @('conv_supervised', 'eb', 4),
  @('conv_supervised', 'eb', 5),
  @('conv_supervised', 'transit', 0),
  @('conv_supervised', 'transit', 1),
  @('conv_supervised', 'transit', 2),
  @('conv_supervised', 'transit', 3),
  @('conv_supervised', 'transit', 4),
  @('conv_supervised', 'transit', 5),
  @('conv_supervised', 'pulsating', 0),
  @('conv_supervised', 'pulsating', 1),
  @('conv_supervised', 'pulsating', 2),
  @('conv_supervised', 'pulsating', 3),
  @('conv_supervised', 'pulsating', 4),
  @('conv_supervised', 'pulsating', 5),
  @('conv_supervised', 'rotation', 0),
  @('conv_supervised', 'rotation', 1),
  @('conv_supervised', 'rotation', 2),
  @('conv_supervised', 'rotation', 3),
  @('conv_supervised', 'rotation', 4),
  @('conv_supervised', 'rotation', 5),
  @('conv_supervised', 'solar_like_osc', 0),
  @('conv_supervised', 'solar_like_osc', 1),
  @('conv_supervised', 'solar_like_osc', 2),
  @('conv_supervised', 'solar_like_osc', 3),
  @('conv_supervised', 'solar_like_osc', 4),
  @('conv_supervised', 'solar_like_osc', 5),
  @('conv_supervised', 'flare', 0),
  @('conv_supervised', 'flare', 1),
  @('conv_supervised', 'flare', 2),
  @('conv_supervised', 'flare', 3),
  @('conv_supervised', 'flare', 4),
  @('conv_supervised', 'flare', 5),
  @('conv_supervised', 'numax_hon', 0),
  @('conv_supervised', 'numax_hon', 1),
  @('conv_supervised', 'numax_hon', 2),
  @('conv_supervised', 'numax_hon', 3),
  @('conv_supervised', 'numax_hon', 4),
  @('conv_supervised', 'numax_hon', 5),
  @('conv_supervised', 'osc_giant', 0),
  @('conv_supervised', 'osc_giant', 1),
  @('conv_supervised', 'osc_giant', 2),
  @('conv_supervised', 'osc_giant', 3),
  @('conv_supervised', 'osc_giant', 4),
  @('conv_supervised', 'osc_giant', 5),
  @('conv_supervised', 'ijspeert', 0),
  @('conv_supervised', 'ijspeert', 1),
  @('conv_supervised', 'ijspeert', 2),
  @('conv_supervised', 'ijspeert', 3),
  @('conv_supervised', 'ijspeert', 4),
  @('conv_supervised', 'ijspeert', 5),
  @('conv_supervised', 'rotation_period', 0),
  @('conv_supervised', 'rotation_period', 1),
  @('conv_supervised', 'rotation_period', 2),
  @('conv_supervised', 'rotation_period', 3),
  @('conv_supervised', 'rotation_period', 4),
  @('conv_supervised', 'rotation_period', 5),
  @('conv_supervised', 'rgb_vs_heb', 0),
  @('conv_supervised', 'rgb_vs_heb', 1),
  @('conv_supervised', 'rgb_vs_heb', 2),
  @('conv_supervised', 'rgb_vs_heb', 3),
  @('conv_supervised', 'rgb_vs_heb', 4),
  @('conv_supervised', 'rgb_vs_heb', 5),
  @('mlp_raw', 'eb', 0),
  @('mlp_raw', 'eb', 1),
  @('mlp_raw', 'eb', 2),
  @('mlp_raw', 'eb', 3),
  ...
  @('mlp_raw', 'solar_like_osc', 3),
  @('mlp_raw', 'solar_like_osc', 4),
  @('mlp_raw', 'solar_like_osc', 5),
  @('mlp_raw', 'flare', 0),
  @('mlp_raw', 'flare', 1),
  @('mlp_raw', 'flare', 2),
  @('mlp_raw', 'flare', 3),
  ...
  @('mlp_raw', 'rotation_period', 3),
  @('mlp_raw', 'rotation_period', 4),
  @('mlp_raw', 'rotation_period', 5),
  @('mlp_raw', 'rgb_vs_heb', 0),
  @('mlp_raw', 'rgb_vs_heb', 1),
  @('mlp_raw', 'rgb_vs_heb', 2),
  @('mlp_raw', 'rgb_vs_heb', 3),
  @('mlp_raw', 'rgb_vs_heb', 4),
  @('mlp_raw', 'rgb_vs_heb', 5)
)
