# GENERATED FROM experiments/configs/rotation_pool.yaml - DO NOT EDIT (edit the manifest and re-run swm.exp.gen_supervised)
# rotation_pool - TRAINING, run in your own terminal (GPU + W&B online).
# Plan: docs/plans/2026-09-20-rotation-pool-design.md rows C1/C2. Boundary: docs/adr/0012-recipe-unfreeze-and-probe-boundary.md (external baselines, never the probe).
# 24 runs = 2 arms x 2 tasks x 6 seeds. Estimated 2.0 h total; pilot 10 min.
...
#         .\experiments\run_rotation_pool_supervised.ps1 -PilotOnly   # 2 runs, then STOP for the gate
#         .\experiments\run_rotation_pool_supervised.ps1              # the full queue
#         .\experiments\run_rotation_pool_supervised.ps1 -DryRun
...
$manifest = "$repo\experiments\configs\rotation_pool.yaml"
$root = "$repo\experiments\rotation_pool\c1c2"
