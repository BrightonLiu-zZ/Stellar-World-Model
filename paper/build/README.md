...
- 4 pages excluding references: body ends on page 4, references run pages 5-6, Appendix A sits on
  page 6 after them, Appendix B on page 7 and the Appendix C table on page 8. The 2026 guidelines say "submissions should not exceed 4 pages", desk-reject on
...
The body ends on page 4 at line 155, with only a few empty lines below it. Any addition longer than that needs a matching cut, and
