...
\begin{table}[h]\caption{Ten-task scorecard. Bold marks the best of the three arms under each frozen readout; the two supervised arms are trained end-to-end per task.}
...
task & metric & $n$ (prev.) & feat. & $\mu$ & feat.\,$\oplus$\,$\mu$ & feat. & $\mu$ & feat.\,$\oplus$\,$\mu$ & Conv1D & MLP \\
\midrule
