...
curves into a few dozen engineered features that remain hard to beat. Learned encoders for light
curves have so far been validated on their own, so whether they carry anything those features lack
is unknown. We pre-train a convolutional encoder on unlabelled TESS light curves to predict each
