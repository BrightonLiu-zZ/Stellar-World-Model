...
stars on most tasks. The learned features therefore complement the engineered features rather than
replace them: an encoder trained without labels gives astronomers new features to put beside the
