...
% Provisional author block (roadmap 2.1): names and order agreed 2026-09-20, to be re-confirmed
% against the OpenReview record once 0.4 lands. Yue Ma's affiliation is deliberately absent rather
% than guessed; co-author e-mail addresses are not printed without their consent.
\author{%
  Zijun Liu\\
...
$0.021$--$0.049$ PR-AUC (Appendix~\ref{app:valloss}). An encoder here therefore has to be
...
Note what the two clauses do differently. A star becomes a positive member only through the three
...
nor drawn as a quiet star, and is absent from this pool altogether.
