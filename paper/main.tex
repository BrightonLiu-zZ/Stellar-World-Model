...
produces far more light curves than can be labelled by hand. Astronomers have distilled these light
curves into a few dozen engineered features that remain hard to beat. Previous work has trained
encoders on light curves and judged them by their own downstream scores, but has not asked whether
they carry anything the engineered features lack. We pre-train a convolutional encoder on unlabelled TESS light curves to predict each
...
spanning variability, asteroseismology and rotation. Adding the learned features
